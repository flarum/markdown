  ...
  extend(TextEditor.prototype, 'toolbarItems', function(items) {
    ...
    items.add('markdown', (
      <MarkdownToolbar for={this.textareaId}>
        ...
        <MarkdownButton title={tooltip('link')} icon="fas fa-link" style={{ prefix: '[', suffix: '](https://)', replaceNext: 'url', scanFor: 'https?://' }} />
        <MarkdownButton title={tooltip('image')} icon="fas fa-image" style={{ prefix: '![', suffix: '](https://)', replaceNext: 'src', scanFor: 'https?://' }} />
